...
if __name__ == "__main__":
    ...
    # CMH (Crypto Low Minus High / Reversal):  - Long Low Momentum + Short High Momentum
    # Sorting Metric: MOMENTUM_SCORE
    # Factor definition: LONG Low Char - SHORT High Char --> long_char_is_high=False
    df_cmh = calculate_factor_time_series(df_raw.copy(), 'MOMENTUM_SCORE', 'CMH', long_char_is_high=True)
    print("  -> CMH (Momentum) Factor calculated.")
    ...
    df_factors = pd.concat([df_mkt, df_csmb, df_cmh, df_cihml], axis=1).dropna()
